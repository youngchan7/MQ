package com.cmdc.nge.commonmq.core.consumer.handler;
...
public class InvocableHandlerMethod extends org.springframework.messaging.handler.invocation.InvocableHandlerMethod {
    ...
    public Object invoke(Message<?> message, Object... providedArgs) throws Exception {
        ...
        if (rabbitConsumer != null) {
            ...
            channel.basicQos(1);
            try {
                MongoTemplate mongoTemplate = getMongoTemplate(rabbitConsumer);
                if (!mongoTemplate.collectionExists(ConsumedMessage.class)) {
                    try {
                        mongoTemplate.createCollection(ConsumedMessage.class);
